...
<body onload = "slider()">
    ...
    <div class="slider">
        ...
        <div class="navbar">
            ...
            <ul>
                <li><a href="display.php">TENANT LIST</a></li>
                <li><a href="displayp.php">PAYMENT LIST</a></li>
                <li><a href="displayfl.php">FLAT LIST</a></li>
                <li><a href="displayco.php">COMPLAINT LIST</a></li>
